...
|ID|Category|Risk|
|---|---|---|
|[CAPEC-62@WebServer@WebTraffic](#capec-62webserverwebtraffic)|Subvert Access Control|Cross-Site Request Forgery (CSRF) risk at WebServer via WebTraffic from User|
...
**Risk**:\
⚠ Cross-Site Request Forgery (CSRF) risk at WebServer via WebTraffic from User
